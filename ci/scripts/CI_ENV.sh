#!/bin/bash
export GLM5_2_TINY_MOE_PATH=${CI_SHARE_MODEL}/GLM-5.2-30B
export GLM5_2_MODEL_PATH=${CI_SHARE_MODEL}/GLM-5.2
...
export QWEN3_8_27B_PATH=${CI_SHARE_MODEL}/models--Qwen--Qwen3.8-27B
