...
from xtuner.v1.model.compose.qwen3_5.qwen3_5_config import Qwen3_5_VLMoE35BA3SplitConfig
from xtuner.v1.model.moe.qwen3_5_text_split import Qwen3_5_VLTextMoE35BA3BSplitConfig
...
QWEN3_5_MOE_SPLIT_PATH = os.environ["QWEN3_5_MOE_SPLIT_PATH"]
...
model_cfg = Qwen3_5_VLTextMoE35BA3BSplitConfig(
    ep_size=1, dispatcher="deepep",
    hf_key_mapping={r"^model\.": "model.language_model."},
    float8_cfg=float8_cfg,
    mtp_config=MTPConfig(num_layers=1),
)
