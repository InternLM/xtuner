"""SAC 验证配置（attn）。配套 tools/verify_sac.sh，勿手动单独运行。
...
moe_cfg = Qwen3MoE30BA3Config(ep_size=4, dispatcher="all2all", recompute_cfg=['save_attn'])
