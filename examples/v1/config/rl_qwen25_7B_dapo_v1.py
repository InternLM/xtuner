...
training_sample_params = SampleParams(
    max_tokens=params["max_response_length"], top_k=0, top_p=1.0, temperature=1.0, min_tokens=0
)
...
dapo_judger_cfg = get_dapo_judger_config(tokenizer=tokenizer, **params)
...
evaluator_cfg = get_evaluator_config(tokenizer=tokenizer,compute_metric_func=dapo_compute_metric,sample_params=evaluation_sample_params,**params)
