"""Intern-S2-Preview VL RL (DAPO) example.
...
DAPO cliprange_high=0.28, use_kl_loss=False.
...
DATA_PATH is a JSON meta mapping dataset name -> annotation / media_root.

Launch::

  bash examples/v1/scripts/run_rl.sh \\
    examples/v1/config/rl_interns2_preview_vl_dapo.py \\
...
experimental_name = "interns2_preview_vl_dapo"
total_epochs = 15
