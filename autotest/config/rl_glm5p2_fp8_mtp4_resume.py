...
# 2 nodes x 8 GPUs. CI sets WORLD_SIZE to the node count.
NNODE = int(os.environ.get("WORLD_SIZE", "2"))

# basic settings
experimental_name = "glm5p2_fp8_mtp4_resume"
...
model_cfg.num_nextn_predict_layers = 4
if hasattr(model_cfg, "_normalize_physical_mtp_indexer_types"):
    model_cfg._normalize_physical_mtp_indexer_types()
