...
moe_cfg = Qwen3_5_VLMoE35BA3Config(only_llm_forward=False, compile_cfg=False)
moe_cfg.text_config.ep_size = ep_size
moe_cfg.text_config.vocab_size = 251392
...
dataset_config = [
    {
        "dataset": DatasetConfig(
            ...
            cache_tag=f"interns2_preview_vl_{sample_max_length}",
        ),
