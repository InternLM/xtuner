...
class LossRecorder:
    ...
    def __call__(self, train_step_info, step, epoch, total_step, total_epoch) -> None:
...
class TestTinyGlm52SFTSmoke(DeterministicDDPTestCase):
    ...
    def test_tiny_glm52_sft_smoke(self):
        ...
        try:
            ...
            trainer_cfg.hooks_config = HooksConfig(after_train_step=recorder)
            ...
            assert recorder.losses[-1] <= recorder.losses[0], recorder.losses
