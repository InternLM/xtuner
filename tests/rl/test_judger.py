...
class TestJudgerController(unittest.TestCase):
    ...
    def test_geo_batch_judge_score(self):
        ...
        config = GEO3KJudgerConfig(
            judger_name="geo3k",
            external_cpu=CPUActorPoolConfig(num_actors=4, num_cpus_per_actor=1),
        )
    ...
    def test_multi_judger_router(self):
        ...
        gsm8k_config_1 = GSM8KJudgerConfig(
            ...
            external_cpu=CPUActorPoolConfig(num_actors=2, num_cpus_per_actor=1),
        )
        gsm8k_config_2 = GSM8KJudgerConfig(
            judger_name="openai/gsm8k_2",
            external_cpu=CPUActorPoolConfig(num_actors=8, num_cpus_per_actor=2),
        )
