...
from xtuner.v1.module.decoder_layer.deepseek_v4.hc_block import HCWrapperConfig, hc_post, hc_pre
...
class TestV4DecoderLayerParity:
    ...
    def test_csa_parity_full_hf_anchor(self, hf_parity, atol, monkeypatch) -> None:
        ...
        """
        if hf_parity:
            from xtuner.v1.module.decoder_layer.deepseek_v4 import hc_block
    ...
    def test_subcomponent_probe(self, capsys) -> None:
        ...
        with torch.no_grad():
            ...
            # XTuner hc_post call:
            from xtuner.v1.module.decoder_layer.deepseek_v4.hc_block import hc_post as _hc_post
