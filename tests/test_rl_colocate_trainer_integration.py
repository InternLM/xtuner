...
# Set environment variables for rollout backend
os.environ["XTUNER_USE_LMDEPLOY"] = "1"
os.environ["LMDEPLOY_PATH"] = "/mnt/shared-storage-user/zhaopenghao/github/lmdeploy_0_12_1"
...
QWEN3_PATH = os.environ.get("QWEN3_PATH", "/mnt/shared-storage-user/llmrazor-share/model/Qwen3-8B")
ALPACA_PATH = os.environ.get("ALPACA_PATH", "/mnt/shared-storage-user/llmrazor-share/data/alpaca")
...
class TestRLColocateTrainerIntegration(unittest.TestCase):
    ...
    def build_trainer_config(self, work_dir, checkpoint_interval=1, checkpoint_maxkeep=2, auto_resume=False):
        ...
        # Agent loop manager
        train_dataset = DatasetConfig(name="test_rl", anno_path="/mnt/shared-storage-user/llmrazor-share/data/gsm8k/test.jsonl")
    ...
    def test_rl_train_with_sft(self):
        ...
        del trainer
        ray.shutdown()
        ray.init(num_cpus=40, num_gpus=4, ignore_reinit_error=True)
