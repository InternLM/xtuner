...
- **\[2023/12\]** 🔥 Support multi-modal VLLM pretraining and fine-tuning with [LLaVA-v1.5](https://github.com/haotian-liu/LLaVA) architecture! To get started, please check out the [docs](<>) and access the LLaVA-InternLM models on [HuggingFace](https://huggingface.co/xtuner) and [ModelScope](https://modelscope.cn/organization/xtuner)!
