...
- **\[2024/04\]** Support [Llama 3](xtuner/configs/llama) models! The latest VLM [LLaVA-Llama-3-8B](https://huggingface.co/xtuner/llava-llama-3-8b) / [LLaVA-Llama-3-8B-v1.1](https://huggingface.co/xtuner/llava-llama-3-8b-v1_1) models are released (Click [here](xtuner/configs/llava/llama3_8b_instruct_clip_vit_large_p14_336) for details)!
