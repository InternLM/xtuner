...
Read `docs/design/custom_pack_sampler.md` in your working directory. This file contains the complete specification for what you need to build. 
...
cat docs/design/custom_pack_sampler.md
...
new, you MUST run verification tests. The script is `run_test.sh`.
