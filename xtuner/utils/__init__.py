...
from .constants import (DEFAULT_AUDIO_TOKEN, DEFAULT_IMAGE_TOKEN,
                        DEFAULT_PAD_TOKEN_INDEX, IGNORE_INDEX,
                        IMAGE_TOKEN_INDEX, LLAST_AUDIO_PADDING_TOKEN_INDEX,
...
__all__ = [
    ...
    'SUPPORT_MODELS', 'LLAST_AUDIO_TOKEN_INDEX', 'DEFAULT_AUDIO_TOKEN',
