...
from xtuner.v1.model.moe.qwen3_5_text_split import Qwen3_5_VLTextMoE35BA3BSplitConfig, Qwen3_5_VLTextMoE397BA17BSplitConfig
...
class Qwen3_5_VLMoE397BA17SplitConfig(Qwen3_5_BaseConfig):
    ...
    text_config: MoEConfig = Qwen3_5_VLTextMoE397BA17BSplitConfig(hf_key_mapping={r"^model\.": "model.language_model."})
