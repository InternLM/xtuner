...
def apply_selective_checkpointing(
    ...
    *,
    ...
    """
    context_fn = partial(_selective_checkpoint_contexts, kept_ops) if keeps_any_unit else None
...
def in_recompute_unit(unit: RecomputeUnit, func: Any) -> Any:
    ...
    :class:`~xtuner.v1.utils.selective_checkpointing.KeptCallables` target names, together with
