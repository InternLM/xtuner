...
class HooksConfig(BaseModel):
    ...
    @field_validator("after_train_step", "after_save_dcp", "after_save_hf", "after_save_snapshot", mode="before")
    def _validate_hooks(
        cls,
    ...
    def __setstate__(self, state):
        valid_state = {k: None if isinstance(v, str) and v.startswith("<unpicklable:") else v for k, v in state.items()}
