    ...
    **Examples:**
    ...
    def fit(self):
        ...
        for rollout_idx in range(1, self._rollout_steps + 1):
            ...
            memory_status_dict["onload_and_prepare_data"] = self._get_memory_status()
            # 4. Training Step
            ...
            memory_status_dict["training"] = self._get_memory_status()
            ...
            memory_status_dict["saving_and_sync_weight"] = self._get_memory_status()
            ...
            memory_status_dict["RL_training"] = self._get_memory_status()
