...
class BaseRLTrainerConfig(BaseModel):
    ...
    external_cpu_resources: CPUResourceManagerConfig | None = None
...
class BaseRLTrainer:
    ...
    def _init_common(self, cfg: BaseRLTrainerConfig, *, meta_path: str, logger_tag: str) -> None:
        ...
        self._external_cpu_manager: CPUResourceManager | None = None
...
class RLColocateTrainer(BaseRLTrainer):
    ...
    def __init__(self, cfg: RLColocateTrainerConfig):
        ...
        self._external_cpu_manager = CPUResourceManager(cfg.external_cpu_resources, self._pg)
        ...
        set_cpu_resource_manager(self._external_cpu_manager)
...
class RLDisaggregatedTrainer(BaseRLTrainer):
    ...
    def __init__(self, cfg: RLDisaggregatedTrainerConfig):
        ...
        self._external_cpu_manager = CPUResourceManager(
