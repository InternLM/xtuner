...
def chunk_gated_delta_rule_fwd(
    ...
    return origin_chunk_gated_delta_rule_fwd(q=q, k=k, v=v, g=g, beta=beta, scale=scale, initial_state=initial_state, output_final_state=output_final_state, cu_seqlens=cu_seqlens)
...
def chunk_gated_delta_rule_bwd(
    ...
    return origin_chunk_gated_delta_rule_bwd(q=q, k=k, v=v, g=g, beta=beta, A=A, scale=scale, initial_state=initial_state, do=do, dht=dht, cu_seqlens=cu_seqlens)
