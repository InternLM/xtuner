...
if check_torch_accelerator_available() and check_triton_available():
    ...
    if triton.__version__ >= "3.4.0":
        ...
        from .m_grouped_gemm_TMA_triton3_4 import m_grouped_gemm, m_grouped_gemm_dual_weight
        ...
        m_grouped_gemm_dual_weight = env_not_available_func
...
__all__ = ["k_grouped_gemm", "m_grouped_gemm", "m_grouped_gemm_dual_weight"]
