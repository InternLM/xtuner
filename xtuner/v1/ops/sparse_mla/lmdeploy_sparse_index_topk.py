...
def _ordered_fp32_key(score):
    """Map FP32 to an unsigned key with the same ordering as FP32."""
...
def is_sparse_index_topk_supported(k: int) -> bool:
    """Return whether a model-configured top-k has a compiled
    specialization."""
    return k in _SUPPORTED_TOPK


@tilelang.jit(pass_configs=_PASS_CONFIGS)
def _sparse_index_topk_byte_radix_kernel(
    top_k: int,
    fill: int = _FILL,
...
__all__ = ["is_sparse_index_topk_supported", "sparse_index_topk"]
