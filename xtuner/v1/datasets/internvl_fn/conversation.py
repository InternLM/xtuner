...
We kindly request that you import fastchat instead of copying this file if you wish to use it. If you have changes in
mind, please contribute back so the community can benefit collectively and continue to maintain these valuable
templates.
"""
...
class Conversation:
    ...
    roles: Tuple[str] = ("USER", "ASSISTANT")  # type: ignore
    ...
    stop_str: Union[str, List[str]] = None  # type: ignore
    ...
    def update_last_message(self, message: str):
        ...
        The last message is typically set to be None when constructing the prompt, so we need to update it in-place
        after getting the response from a model.
        """
