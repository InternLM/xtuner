...
from xtuner.v1.datasets import InternS1VLTokenizeFunction, Qwen3VLTokenizeFunction
from xtuner.v1.datasets.config import DatasetConfig
from xtuner.v1.datasets.data_item import OmniDataItem
...
def compress_repeats_token_ids(nums, target):
    if not nums:
        return []
