# This file is seperate from prober.py to avoid circular import.
import types
import torch.nn as nn
from xtuner.v1.model.moe.moe import DenseDecoderLayer, MoEDecoderLayer
from xtuner.v1.loss.moe_loss import BalancingLoss, ZLoss
from xtuner.v1.profiler.prober import ProberList
from xtuner.v1.model.moe.moe import LMHead, MoEBlock
...
def setup_prober_list(exp_dir: str, profile_step: list[int], model: nn.Module, prober_list: list[str]):
