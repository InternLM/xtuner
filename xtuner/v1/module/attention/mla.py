...
class MultiLatentAttention(nn.Module):
    ...
    def forward_training(
        ...
        attn_output = flash_attn_varlen_func(
            ...
            cu_seqlens_q_list=attn_meta.cu_seq_lens_q_list,
            cu_seqlens_k_list=attn_meta.cu_seq_lens_k_list,
    ...
    def prefilling(
        ...
        attn_output = flash_attn_varlen_func(  # type: ignore
            ...
            cu_seqlens_q_list=seq_ctx.cu_seq_lens_q_list,
            cu_seqlens_k_list=seq_ctx.cu_seq_lens_k_list,
