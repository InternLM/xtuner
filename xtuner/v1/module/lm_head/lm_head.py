...
class LMHead(nn.Linear):
    ...
    __call__: Callable[
        ["LMHead", HiddenStates, CELossContext | None], tuple[Loss, tuple[Logits | None, Max_ratio | None]]
    ]
