...
from .base_chat_bot import ChatInstance, HFChatBot, LMDeployChatBot
from .moss_plugins import plugins_api


class MossInstance(ChatInstance):
...
class HFMossBot(HFChatBot):
    ...
    def create_instance(self,
        ...
        return MossInstance(self, bot_name, chat_template, system_template)


class LMDeployMossBot(LMDeployChatBot):
