...
pretrained_pth = 'work_dirs/allava_pretrain/iter_4214.pth'  # noqa: E501

# Data
data_root = '/mnt/petrelfs/share_data/zhaoxiangyu/'
data_path = data_root + 'instruct_llava_allava_doc_dvqa_share_ai2d_1383k.json'
image_folder = '/mnt/petrelfs/share_data/huanghaian/xiangyu_mix_sft_data/'
...
#######################################################################
cache_path = '/mnt/petrelfs/share_data/huanghaian/xiangyu_mix_sft_data/phi3-mini-2k-sft'
pad_image_to_square = True

llava_dataset = dict(
    type=LLaVADataset,
    offline_processed_text_folder=cache_path,
    data_path=data_path,
