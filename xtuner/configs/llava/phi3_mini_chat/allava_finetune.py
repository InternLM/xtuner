...
allava_laion_data_path = data_root1 + 'allava_laion/ALLaVA-Instruct-LAION-4V_llava.json'
...
allava_laion_dataset = dict(
    type=LLaVADataset,
    offline_processed_text_folder=cache_2k_root + 'allava_laion_dataset_sft',
...
train_dataset = dict(
    ...
    datasets=[llava_dataset, sharegpt4v_dataset,
              ...
              synthdog_dataset, allava_laion_dataset, allava_vflan_dataset])
