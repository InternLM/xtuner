...
pretrained_pth = './work_dirs/pretrain_llava/iter_2181.pth'  # noqa: E501
...
cgd_instruction_json = './data/MIMICIT/CGD/CGD_instructions.json'
use_coco_image = True
coco_image_path = './data/llava_data/llava_images/coco/train2017'
...
cgd_dataset = dict(
    ...
    per_image_length=per_image_length,
    image_processor=image_processor,
    dataset_map_fn=mimicit_map_fn,
    template_map_fn=dict(
        type=template_map_fn_factory, template=prompt_template),
    max_length=max_length,
    pad_image_to_square=True)

train_dataset = dict(type=ConcatDataset, datasets=[llava_dataset, cgd_dataset])
