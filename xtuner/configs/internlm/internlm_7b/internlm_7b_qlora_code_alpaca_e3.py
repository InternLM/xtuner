...
from xtuner.datasets.map_fns import code_alpaca_map_fn
...
custom_hooks = [
    ...
    dict(
        ...
        instruction=PROMPT_TEMPLATE.code_alpaca.INSTRUCTION_START)
]
