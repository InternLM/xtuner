...
def main():
    parser = argparse.ArgumentParser(description="Serial Merge Weights and Convert to Hugging Face Format")
    parser.add_argument('ckpt_dir', type=str, help='The directory where the weight file is located')
    parser.add_argument('config_path', type=str, help='Configuration file path used for training')
    parser.add_argument('output_dir', type=str, help='Hugging Face model output directory')
